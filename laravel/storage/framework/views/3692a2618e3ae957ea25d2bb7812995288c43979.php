         ...
         <div class="modal-body">
            ...
            <div class="form-group">
               ...
               <div class="col-sm-4" class="form-control">
                  <select name="provinceId" class="form-control" id="province" placeholder="Province" onchange="select.load(this, '<?php echo e(url('/city/by-province')); ?>', 'container-city');" data-token="<?php echo e(csrf_token()); ?>" data-selectedid="" required="required">
...
<script>
   ...
   {
      initAutocomplete();
      saveManager.submit("form-add", "<?php echo e(url('/membership/zones/add')); ?>");
   });
