...
$(document).ready(function() {
   listManager.listUrl = "<?php echo e(url('administration/cities')); ?>";
   ...
   listManager.ready();
   popupManager.urlAdd = "<?php echo e(url('administration/cities/add')); ?>"
   popupManager.urlUpdate = "<?php echo e(url('administration/cities/update')); ?>"
