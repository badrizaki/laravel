						...
						<div class="row">
							<div class="col-lg-12">
					            ...
					            <div class="form-group">
					               	...
					               	<div class="col-sm-9">
					                  	<input type="text" name="prodName" class="form-control" id="prodName" placeholder="Prod Name" required="" value="<?php echo e(old('prodName', isset($item) ? $item->prodName : '')); ?>" />
					               	</div>
					            </div>
					            ...
					            <div class="form-group">
					               ...
					               <div class="col-sm-4">
					                  	<input type="text" name="monthlyOutput" class="form-control onlyNumeric" id="MonthlyOutput" placeholder="Monthly Output" required="" readonly="" value="<?php echo e(old('monthlyOutput', isset($item) ? $item->monthlyOutput : '')); ?>" />
					               </div>
					            </div>
					            ...
					            <div class="form-group">
					               ...
					               <div class="col-sm-4">
					                  	<input type="text" name="pet" class="form-control onlyNumeric" id="pet" placeholder="PET" required="" value="<?php echo e(old('pet', isset($item) ? $item->pet : '0')); ?>" />
					               </div>
					            </div>
					            ...
					            <div class="form-group">
					               ...
					               <div class="col-sm-4">
					                  	<input type="text" name="overhead" class="form-control onlyNumeric" id="overhead" placeholder="Overhead" required="" value="<?php echo e(old('overhead', isset($item) ? $item->overhead : '0')); ?>" readonly="" />
					               </div>
					               <div class="col-sm-4">
					            ...
					            <div class="form-group">
					               ...
					               <div class="col-sm-4">
					                  	<input type="text" name="packaging" class="form-control onlyNumeric" id="packaging" placeholder="Packaging" required="" value="<?php echo e(old('packaging', isset($item) ? $item->packaging : '0')); ?>" readonly="" />
					               </div>
					               <div class="col-sm-4">
					            ...
					            <div class="form-group">
					               ...
					               <div class="col-sm-4">
					                  	<input type="text" name="shipment" class="form-control onlyNumeric" id="shipment" placeholder="Shipment" required="" value="<?php echo e(old('shipment', isset($item) ? $item->shipment : '0')); ?>" readonly="" />
					               </div>
					               <div class="col-sm-4">
					            ...
					            <div class="form-group">
					               ...
					               <div class="col-sm-4">
					                  	<input type="text" name="amortz" class="form-control onlyNumeric" id="amortz" placeholder="Amortz" required="" value="<?php echo e(old('amortz', isset($item) ? $item->amortz : '0')); ?>" readonly="" />
					               </div>
					               <div class="col-sm-4">
					            ...
					            <div class="form-group">
					               ...
					               <div class="col-sm-4">
					                  	<input type="text" name="pigment" class="form-control onlyNumeric" id="pigment" placeholder="Pigment" required="" value="<?php echo e(old('pigment', isset($item) ? $item->pigment : '0')); ?>" readonly="" />
					               </div>
					               <div class="col-sm-4">
					            ...
					            <div class="form-group">
					               ...
					               <div class="col-sm-4">
					                  	<input type="text" name="totalCost" class="form-control onlyNumeric" id="totalCost" placeholder="Cost" required="" value="<?php echo e(old('totalCost', isset($item) ? $item->totalCost : '0')); ?>" readonly="" />
					               </div>
					               <div class="col-sm-4">
					            ...
					            <div class="form-group">
					               ...
					               <div class="col-sm-4">
					                  	<input type="text" name="profit" class="form-control onlyNumeric" id="profit" placeholder="Cost" required="" value="<?php echo e(old('profit', isset($item) ? $item->profit : '0')); ?>" readonly="" />
					               </div>
					               <div class="col-sm-4">
					            ...
					            <div class="form-group">
					               ...
					               <div class="col-sm-8">
					                  	<input type="text" name="btlPrice" class="form-control onlyNumeric" id="btlPrice" placeholder="Cost" required="" value="<?php echo e(old('btlPrice', isset($item) ? $item->btlPrice : '0')); ?>" readonly="" />
					               </div>
					            </div>
...
{    
    ...
    $("#percentageProfit").keyup(function (e)
    {
    	...
    	var resultProfit = totalCost * percentageProfit;
...
function totalCost()
{
	...
	$('#btlPrice').val($.number(resultCost, 2));

	// cost PERCENTAGE
	var percentagePET = parseFloat(PET) / parseFloat(resultCost) * 100;
	$('#percentagePET').val($.number(percentagePET));

	var percentageOverhead = parseFloat(Overhead) / parseFloat(resultCost);
	$('#percentageOverhead').val($.number(percentageOverhead));
	
	var percentagePackaging = parseFloat(Packaging) / parseFloat(resultCost);
	$('#percentagePackaging').val($.number(percentagePackaging));
	
	var percentageShipment = parseFloat(Shipment) / parseFloat(resultCost);
	$('#percentageShipment').val($.number(percentageShipment));

	var percentageAmortz = parseFloat(Amortz) / parseFloat(resultCost);
	$('#percentageAmortz').val($.number(percentageAmortz));

	var percentagePigment = parseFloat(Pigment) / parseFloat(resultCost);
	$('#percentagePigment').val($.number(percentagePigment));

	console.log('percentagePET = ' + percentagePET + "\n");
	console.log('percentageOverhead = ' + percentageOverhead + "\n");
	console.log('percentagePackaging = ' + percentagePackaging + "\n");
	console.log('percentageShipment = ' + percentageShipment + "\n");
	console.log('percentageAmortz = ' + percentageAmortz + "\n");
	console.log('percentagePigment = ' + percentagePigment + "\n");
