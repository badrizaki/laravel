...
$(document).ready(function() {
   listManager.listUrl = "<?php echo e(route('customerList')); ?>";
   ...
   listManager.ready();
   popupManager.urlAdd = "<?php echo e(route('customerCreate')); ?>"
   popupManager.urlUpdate = "<?php echo e(route('customerEdit')); ?>"
