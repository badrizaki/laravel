...
<head>
   ...
   <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(url('assets/img/icon.png')); ?>">
   ...
   <nav class="bars-menu navbar navbar-default" role="navigation">
      <div class="container-fluid" id="navfluid">
         <div class="navbar-header">
            ...
            <div class="logo">
               <a class="navbar-brand" href="<?php echo e(url('')); ?>"><img src="<?php echo e(url('assets/img/logo-2.png')); ?>"></a>
               <div class="clearfix"></div>
            </div>
         </div>
         <div class="collapse navbar-collapse" id="navigationbar">
            <ul class="nav navbar-nav">
               <li><a href="<?php echo e(route('map')); ?>"><i class="fa fa-map-marker" aria-hidden="true"></i>&nbsp;&nbsp;Map</a></li>
               <li><a href="<?php echo e(route('vehicleSummary')); ?>"><i class="fa fa-file-text-o" aria-hidden="true"></i>&nbsp;&nbsp;Vehicle Summary</a></li>    
               <li><a href="<?php echo e(route('job-order')); ?>"><i class="fa fa-cube" aria-hidden="true"></i>&nbsp;&nbsp;Job Order</a></li>    
               <li><a href="<?php echo e(route('administration')); ?>"><i class="fa fa-cogs" aria-hidden="true"></i>&nbsp;&nbsp;Administration</a></li>    
               <li><a href="<?php echo e(route('historyShipping')); ?>"><i class="fa fa-file-text-o" aria-hidden="true"></i>&nbsp;&nbsp;History Shipping</a></li>
            </ul>
