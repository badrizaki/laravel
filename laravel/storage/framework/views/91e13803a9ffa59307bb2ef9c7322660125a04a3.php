...
$(document).ready(function() {
   listManager.listUrl = "<?php echo e(route('categoryList')); ?>";
   ...
   listManager.ready();
   popupManager.urlAdd = "<?php echo e(route('categoryCreate')); ?>"
   popupManager.urlUpdate = "<?php echo e(route('categoryEdit')); ?>"
