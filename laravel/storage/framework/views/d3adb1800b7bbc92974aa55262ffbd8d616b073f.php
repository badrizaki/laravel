...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCQY8y6hXZ_H1u88seGAAqi577Y9ecTc3c&libraries=places" async defer></script>
<script type="text/javascript">
$(document).ready(function() {
   listManager.listUrl = "<?php echo e(url('membership/zones')); ?>";
   ...
   listManager.ready();
   popupManager.urlAdd = "<?php echo e(url('/membership/zones/add')); ?>"
   popupManager.urlUpdate = "<?php echo e(url('/membership/zones/update')); ?>"
