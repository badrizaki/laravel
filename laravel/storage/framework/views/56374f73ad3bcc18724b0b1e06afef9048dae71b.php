   ...
   <div class="row row-offcanvas row-offcanvas-left">
      <div class="col-xs-12 content">
         ...
         <div class="btn-container">
            <a href="<?php echo e(route('calculator.create')); ?>" class="btn btn-primary">Add New</a>
         </div>
...
$(document).ready(function() {
   listManager.listUrl = "<?php echo e(route('currency.index')); ?>/list";
   listManager.deleteUrl = "<?php echo e(route('currency.index')); ?>";
