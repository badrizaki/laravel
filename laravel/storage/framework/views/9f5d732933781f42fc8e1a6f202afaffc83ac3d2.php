...
<div class="container-fluid" id="container-content">
   <div class="row row-offcanvas row-offcanvas-left">
      ...
      <div class="col-xs-12 col-sm-10 container-trailing">
         <div class="trailing">Administration / Zone</div>
      </div>
      <div class="col-xs-12 col-sm-10 content">
         ...
         <div class="btn-container">
            <a href="<?php echo e(route('zone.create')); ?>" class="btn btn-add">Add New</a>
         </div>
...
$(document).ready(function() {
   listManager.listUrl = "<?php echo e(route('zone.index')); ?>/list";
   listManager.deleteUrl = "<?php echo e(route('zone.index')); ?>";
