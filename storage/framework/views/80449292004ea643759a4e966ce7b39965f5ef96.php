      ...
      <div class="container-fluid" id="navfluid">
         ...
         <div class="collapse navbar-collapse" id="navigationbar">
            <ul class="nav navbar-nav">
               ...
               <li><a href="<?php echo e(url('vehicle-summary')); ?>"><i class="fa fa-file-text-o" aria-hidden="true"></i>&nbsp;&nbsp;Vehicle Summary</a></li>    
               <li><a href="<?php echo e(url('job-order')); ?>"><i class="fa fa-cube" aria-hidden="true"></i>&nbsp;&nbsp;Job Order</a></li>    
               <li><a href="<?php echo e(url('administration')); ?>"><i class="fa fa-cogs" aria-hidden="true"></i>&nbsp;&nbsp;Administration</a></li>    
               <li><a href="<?php echo e(url('history-shipping')); ?>"><i class="fa fa-file-text-o" aria-hidden="true"></i>&nbsp;&nbsp;History Shipping</a></li>
            </ul>
