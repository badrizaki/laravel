   ...
   <div class="row row-offcanvas row-offcanvas-left">
      ...
      <div class="col-xs-12 col-sm-10 content">
         ...
         <div class="btn-container">
            <a href="<?php echo e(route('category.create')); ?>" class="btn btn-add">Add New</a>
         </div>
...
$(document).ready(function() {
   listManager.listUrl = "<?php echo e(route('category.index')); ?>/list";
   listManager.deleteUrl = "<?php echo e(route('category.index')); ?>";
