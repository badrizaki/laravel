...
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(env('GMAP_KEY')); ?>&libraries=places" async defer></script>
<script type="text/javascript">
$(document).ready(function() {
   listManager.listUrl = "<?php echo e(route('zone')); ?>";
   ...
   listManager.ready();
   popupManager.urlAdd = "<?php echo e(route('zoneCreate')); ?>"
   popupManager.urlUpdate = "<?php echo e(route('zoneEdit')); ?>"
