...
$(document).ready(function() {
   listManager.listUrl = "<?php echo e(url('administration/provinces')); ?>";
   ...
   listManager.ready();
   popupManager.urlAdd = "<?php echo e(url('administration/provinces/add')); ?>"
   popupManager.urlUpdate = "<?php echo e(url('administration/provinces/update')); ?>"
